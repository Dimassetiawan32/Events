...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 bg-teal-900 border-button shadow-sm">
        ...
        <div class="jumbotron" style="background-image: url('banner/bg.png')">
            <div class="container">
                <h3 class="text-center">Aplikasi Management Kegiatan</h3>
                <h1 class="display-3 text-center">AB Nihhboss!!</h1>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card border-0">
                                <img src="{{asset('banner/manage.png')}}" 
                                     alt=""
                                     class="card-img-top">
                                <div class="card-body">
                                    <h3>Manage Event</h3>
                        ...
                        <div class="col-md-4">
                            <div class="card border-0">
                                <img src="{{asset('banner/regis.png')}}" 
                                     alt=""
                                     class="card-img-top">
                                <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card border-0">
                                <img src="{{asset('banner/aktif.png')}}" 
                                     alt=""
                                     class="card-img-top">
                                <div class="card-body">
